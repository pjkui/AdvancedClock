...
- **按农历年循环** 🌙🆕：每年在农历指定日期触发（如农历生日、传统节日等）

### 1.1 农历闹钟 🌙🆕
- **农历日期支持**：支持设置农历日期的闹钟（如农历八月十五）
- **闰月支持**：支持闰月设置（如闰四月、闰六月等）
- **自动转换**：自动将农历日期转换为公历日期
- **每年循环**：每年农历同一天自动触发，无需手动更新
- **日期范围**：支持 1900-2100 年的农历日期
- **传统节日**：适合设置春节、端午、中秋等传统节日提醒
- **农历生日**：完美支持农历生日提醒
- **主界面显示** 🆕：主界面实时显示当前农历日期（如：🌙 农历：2025年腊月廿一）
- **详细说明**：[农历闹钟功能指南](docs/LUNAR_ALARM_GUIDE.md) | [主界面农历显示](docs/MAIN_WINDOW_LUNAR_DISPLAY.md)
...
### 2025-12-20 主界面新增农历日期显示 🌙🆕
- ✅ 主界面实时显示当前农历日期
- ✅ 每秒自动更新农历信息
- ✅ 醒目的颜色和图标设计（🌙 橙色）
- ✅ 完整显示农历年月日（如：2025年腊月廿一）
- ✅ 支持闰月显示（如：闰四月初十）
- ✅ 与农历闹钟功能完美配合
- ✅ 性能优秀，不影响其他功能
- ✅ 详细说明文档：[主界面农历显示](docs/MAIN_WINDOW_LUNAR_DISPLAY.md)
...
- ✅ 自动将农历日期转换为公历日期
- ✅ 每年农历同一天自动触发，无需手动更新
- ✅ 支持 1900-2100 年的农历日期范围
- ✅ 完美支持传统节日和农历生日提醒
- ✅ 实时显示农历与公历日期对应关系
- ✅ 创建 LunarCalendarService 农历计算服务
- ✅ 详细说明文档：[农历闹钟功能指南](docs/LUNAR_ALARM_GUIDE.md)
...
- [系统托盘使用指南](docs/TRAY_GUIDE.md) - 托盘功能详细说明
- [数据持久化说明](docs/DATA_PERSISTENCE.md) - 数据存储机制
- [开机自动启动说明](docs/AUTO_START.md) - 自启动配置
- [声音增强功能指南](docs/SOUND_ENHANCEMENT_GUIDE.md) - 自定义声音功能
- [农历闹钟功能指南](docs/LUNAR_ALARM_GUIDE.md) - 农历闹钟使用说明 🌙🆕
- [主界面农历显示](docs/MAIN_WINDOW_LUNAR_DISPLAY.md) - 主界面农历日期显示 🌙🆕
- [Git 标签管理指南](docs/GIT_TAG_GUIDE.md) - 版本标签管理 🆕
- [声音文件修复说明](docs/SOUND_FILES_FIX.md) - 声音文件部署问题修复
